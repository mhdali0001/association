...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * نسخ ملفات المستخدمين المرفوعة فقط (صور المستفيدين، مرفقات الملاحظات…).
                 * لا نضمّ base_path() لتفادي vendor/.git/.env/بناء Vite.
                 */
                'include' => [
                    storage_path('app'),
                ],
        ...
        'destination' => [
            ...
            /*
             * أقراص الوجهة — من BACKUP_DISKS في .env (مثال على الخادم: backups,b2).
             */
            ...
            /*
             * لو فشل الرفع لوجهة (مثلاً B2)، أكمل واحتفظ بالنسخة المحلية بدل فشل العملية كاملة.
             */
    ...
    'notifications' => [
        'notifications' => [
            // إشعارات الفشل فقط — رسائل النجاح اليومية تُتجاهَل وتُخفي الأعطال الحقيقية.
        ...
        'mail' => [
            // على الخادم اضبط BACKUP_NOTIFICATION_EMAIL ببريدك؛ القيمة الفارغة تسقط للاحتياطي.
            'to' => env('BACKUP_NOTIFICATION_EMAIL') ?: env('MAIL_FROM_ADDRESS') ?: 'no-reply@example.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hello@example.com'),
                'name' => env('MAIL_FROM_NAME', 'مسالك النور'),
            ],
        ],
